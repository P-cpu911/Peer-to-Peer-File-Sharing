So well, I have no idea to write a markdown file.
But I will try.

There are 2 program: peer.c and index_server.c. Assume you name the executable file as "peer" and "iserver", respectively.
Upon running, the syntax should be:
